...
require 'controladores/objetos.php';
require 'controladores/sync.php';
require 'controladores/midht11.php';
...
$recursos_existentes = array('objetos', 'usuarios', 'sync', 'midht11');
...
switch ($metodo) {
    case 'get':
  // $vista->imprimir(objetos::get($peticion));
